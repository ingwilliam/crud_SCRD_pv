        ...
        if (isset($token_actual->id)) {
            ...
            if ($permiso_escritura == "ok") {
                ...
                if($ver_reportes)
                {
                    ...
                    $array_retorno["reporte_convocatorias_listado_inscritas_pdac"]="<a href='javascript:void(0);' rel='". json_encode($params)."' class='btn reporte_convocatorias_listado_inscritas_pdac'>Generar Reporte <i class='fa fa-file-excel-o'></i></a>";                
        ...
        if (isset($token_actual->id)) {
            ...
            if ($permiso_escritura == "ok") {
                ...
                if($ver_reportes)
                {
                    ...
                    //Se comenta para quitar boton pdf
                    ...
                    $array_retorno["reporte_ganadores"]="<a href='javascript:void(0);' rel='". json_encode($params)."' class='btn reporte_propuestas_ganadoras'>Generar Reporte <i class='fa fa-file-excel-o'></i></a>";                
                    $array_retorno["reporte_convocatorias_listado_participantes"]="<a href='javascript:void(0);' rel='". json_encode($params)."' class='btn reporte_convocatorias_listado_participantes'>Generar Reporte <i class='fa fa-file-excel-o'></i></a>";
    ...
    try {
        ...
        if (isset($token_actual->id)) {
            ...
            if ($permiso_escritura == "ok") {
                ...
                $params=array("token"=>$request->get('token'),"entidad"=>$request->get('entidad'),"anio"=>$request->get('anio'));
                $params1=array("token"=>$request->get('token'),"anio"=>$request->get('anio'));
                //Seteo los varoles a retornar
